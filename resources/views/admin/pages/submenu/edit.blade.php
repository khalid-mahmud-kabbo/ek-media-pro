@extends('admin.frontend', ['menu' => 'menus', 'submenu' => 'submenus'])
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                            <form enctype="multipart/form-data" method="POST"
                                action="{{ route('admin.update_submenu', encrypt($submenu->id)) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="en-name" name="en_name"
                                                    placeholder="{{ __('Name') }}" value="{{ $submenu->en_name }}"
                                                    required="">
                                            </div>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="url" name="url"
                                                    placeholder="{{ __('URL') }}" value="{{ $submenu->url }}"
                                                    required="">
                                            </div>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="{{ ACTIVE }}"
                                                        {{ $submenu->status == ACTIVE ? 'selected' : '' }}>
                                                        {{ __('Publish') }}</option>
                                                    <option value="{{ INACTIVE }}"
                                                        {{ $submenu->status == INACTIVE ? 'selected' : '' }}>
                                                        {{ __('Draft') }}</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="fr-name" name="fr_name"
                                                    placeholder="{{ __('Name') }}" value="{{ $submenu->fr_name }}"
                                                    required="">
                                            </div>
