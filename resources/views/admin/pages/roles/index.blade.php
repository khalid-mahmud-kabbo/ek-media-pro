@extends('admin.layout.master', ['menu' => 'admins', 'submenu' => 'roles'])
@section('title', isset($title) ? $title : '')
@section('content')

    <div id="table-url" data-url="{{ route('admin.role_list') }}"></div>
    <div class="row">
        <div class="col-md-12">
    ...
    <!--Row-->
    @push('post_scripts')
        <script src="{{asset('backend/js/admin/datatables/roles.js')}}"></script>
