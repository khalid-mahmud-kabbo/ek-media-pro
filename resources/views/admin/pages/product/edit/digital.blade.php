                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_about" id="en_about" class="form-control" placeholder="{{ __('About') }}">{{ $product->en_About }}</textarea>
                                                @error('en_about')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_additionalinformation" id="summernote2" class="form-control">{!! $product->en_AdditionalInformation !!}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="fr_description" id="summernote3" class="form-control">{!! $product->fr_Description !!}</textarea>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="fr_additionalinformation" id="summernote4" class="form-control">{!! $product->fr_AdditionalInformation !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
