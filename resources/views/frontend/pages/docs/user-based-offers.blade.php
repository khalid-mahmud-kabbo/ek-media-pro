...
<div class="row">
    ...
    <div class="card body-text">
        <div class="card-header card-header-info card-header-text">
            <div class="card-text">
                <h4 class="card-title">User Based Surveys API Documentation</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <p>
                Our user based surveys API consists of a single API call which retrieves in JSON format a list of all of
                matching surveys for a particular user.
            </p>
            <p>
            ...
            <p>
                ...
                <br>
                - Keep in mind that the surveys shown are based on the filter values provided from your side, so we
    ...
    <div class="card">
        <div class="card-header card-header-success card-header-text">
            <div class="card-text">
                <h4 class="card-title">API Response</h4>
            </div>
        </div>
        <div class="card-body">
            <h3>Response 200</h3>
    ...
    <div class="card">
        ...
        <div class="card-body body-text">
            <p>
                Should I store the response at my end?<br>
                No, these are dynamic, user based response and should not be stored at your end.
            </p>
            <p>
                Where should I use this API?<br>
                In your offer listing page for the user, where you can get the user details, most likely in your own
                offerwall page.
            </p>
            <p>
                How should I use this API?<br>
                Apart from storing the static offers from All Offers API response at your end, filtering those offers
                based on user details, and displaying the offers in your offerwall, you can make an API call on page
                load once
                you get the required user details. <br>
                This API returns available Surveys based on user details provided and should only be used for that
                specific user.
            </p>
        </div>
    </div>
